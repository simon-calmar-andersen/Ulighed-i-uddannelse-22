...
\section*{Referencer}
Lav en reference, til en artikel som du har eksporteret fra Zotero. Øverst i denne Latex-skabelon (linje 22 i skabelonen) skal du indsætte navnet på din bib-fil (som skal ligge i samme mappe som tex-filen)  og fjerne  \% -tegnet. I bib-bilen kan du se, hvilken "key" din reference har fået. Typisk er det \verb|efternavn_første-ord-titel_årstal|. Referencen indsættes med 
...
\section*{Figurer}
Når du gemt en figur-fil i samme mappe som denne tex-fil, skal du indsætte dens navn. Du kan henvise til figuren ved at indsætte reference til dens label \verb|\ref{figur-label}|.
